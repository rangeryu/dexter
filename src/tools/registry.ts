  ...
  const tools: RegisteredTool[] = [
    {
      ...
      compactDescription: 'Financial statements and metrics for US and China A-shares. Handles multi-company/multi-metric queries in one call.',
    ...
    },
    {
      ...
      compactDescription: 'US/CN stock and ETF prices, crypto prices, news, disclosures, and insider trades. Handles multi-asset queries in one call.',
      concurrencySafe: true,
    },
    {
      name: 'read_filings',
      ...
      compactDescription: 'SEC filings (10-K, 10-Q, 8-K) and China A-share announcements/disclosures.',
      concurrencySafe: true,
    },
    {
      name: 'stock_screener',
      ...
      compactDescription: 'Screen US stocks by financial criteria and China A-shares by valuation, industry, and market cap.',
      concurrencySafe: true,
    },
    {
      name: 'web_fetch',
